...
MVP16 draw-gesture 마일스톤(`docs/superpowers/plans/2026-07-21-draw-gesture.md` Task 3)에서
...
`docs/qa/2026-07-21-draw-gesture-device-checklist.md` 세션 1의 1-2번 항목("가장 먼저,
...
- `docs/superpowers/plans/2026-07-21-draw-gesture.md` — "검증 현실" 섹션, 🚦 결정 게이트
