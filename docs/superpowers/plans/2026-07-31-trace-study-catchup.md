...
- [ ] **3. 지도 위에 표시하는 법** → [`3-map-rendering/`](../../study/3-map-rendering/)
      · **진행 중 — 소개 3절 완료(2026-08-15). 다음은 파트 1 「SwiftUI 밖으로 나가기 —
        `MKMapView`를 SwiftUI에 얹는 법」.** **8파트** 구성 확정(7파트에서 개정 — 감싸기 파트를
        신설하고 색↔타입 순서를 뒤집었다) · 브랜치 `docs/study-chunk-3` · 발행
        <https://claude.ai/code/artifact/8a7a02b4-6ed3-4214-9436-3291a7886aed>
        · 🔑 **파트 1 착수 메모는 `agent-log.md` 맨 아래에 있다** — 능력 선언·담을 것 다섯·재료 경로·
        조심할 것까지 적어뒀다. **재료는 착수 메모 말고 코드에서 다시 뽑는다.**
      · ⚠️ **도식은 mermaid가 아니다** — 새 도식은 `diagram-design`으로 만든 **정적 인라인 SVG**
        (`SKILL.md`「노트 형식 · 도식」, 2026-08-15 개정). **파트 1은 도식 ○이라 바로 걸린다.**
