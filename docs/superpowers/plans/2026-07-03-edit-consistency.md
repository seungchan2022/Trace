...
- [ ] **Step 1: 기존 테스트를 새 규칙 기대값으로 재구성 (실패 테스트 작성)**
...
- [ ] **Step 2: 테스트 실행 — 신규/교체 테스트 FAIL 확인**
...
- [ ] **Step 1: MapPin에 role 추가 + diff 확장**
