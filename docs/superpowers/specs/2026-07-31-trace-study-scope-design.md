...
| 무엇 | 어디 | 왜 |
|---|---|---|
| 덩어리별 학습 문서 | `docs/study/<번호>-<슬러그>/` 폴더 — `note.html` + `agent-log.md` | 기능 단위. MVP 단위가 아니다(§7). **설계 당시에는 `.md` 한 파일이었다** — 2026-08-02에 HTML+Artifact로, 2026-08-10에 폴더로 바뀌었다(현재 규약은 `SKILL.md`의 `[4] 저장`) |
