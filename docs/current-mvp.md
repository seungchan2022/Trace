...
**진행 중인 MVP 없음.** 다음 MVP는 아직 스코핑하지 않았으며, 현재 상태의 정본은 [로드맵](roadmap.md)이다.
...
마지막 갱신: 2026-09-01
근거: [로드맵의 진행 중 / 예정 상태](roadmap.md#진행-중--예정) · [MVP17 완료 회고](../history/mvp17/260727_mvp17_completion_retro.md)
