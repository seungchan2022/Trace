...
| 순위 | 축 | 건수 | 단위 제안 | 조건 |
|---|---|---:|---|---|
| ~~1~~ **착수** | 페이스 표시·계산 | 5 (+딸려올 후보 2) | **MVP 밖 독립 사이클** — 마일스톤 2개 정도라 MVP 기준(2~5개)에 미달한다 | 발동 — 2026-08-30 실사용 관찰(발화와 잠금화면의 페이스가 달라 오작동으로 읽혔다) |
...
**1·3순위에 MVP 절차를 씌우지 않는다.** MVP로 잡으면 킥오프(`brainstorming` decompose ·
