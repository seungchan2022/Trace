...
| 순위 | 축 | 건수 | 단위 제안 | 조건 |
|---|---|---:|---|---|
| 1 | 페이스 표시·계산 | 7 | 사이클 1개 (마일스톤 2개 정도) | 발동 — 2026-08-30 실사용 관찰(발화와 잠금화면의 페이스가 달라 오작동으로 읽혔다) |
| 2 | 코스 편집 UX + 지도 렌더링 + `MapViewRepresentable` 분해 | 9 | **MVP 1개** (마일스톤 3~4개) | 발동 — 2026-08-19·21·24 관찰(핀·흰 점 깜빡임, 고른 구간이 안 풀림) |
| 3 | 코스 계획 라우팅 | 7 | **MVP 밖 독립 사이클** — 사용자 가치가 없는 내부 정리다 | 미발동. 다만 다른 축에 걸리지 않아 언제든 착수할 수 있다 |
| — | 대기 | 37 | 순서에 넣지 않는다 | 실사용 조건이 아직 오지 않았다 |
